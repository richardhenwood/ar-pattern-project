...
4. Load the SVG into [ar-project-pattern](https://github.com/richardhenwood/ar-pattern-project) and use my Meta Quest 3 to mark the pattern onto my fabric with chalk. 
5. I cut out the pattern and sew it up.
